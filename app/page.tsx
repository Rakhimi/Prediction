  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-background">
        {/* Subscribe Section */}
      <section className="bg-black/95 py-12 px-6 border-y border-orange-500/20">
        <div className="max-w-6xl mx-auto flex flex-col items-center gap-8">
          
          {/* Title */}
          <div className="flex items-center gap-4">
            <h2 className="text-2xl md:text-3xl font-bold text-orange-600 uppercase tracking-tight">
              Subscribe now to Unlock All Predictions
            </h2>
            <a href="#" className="text-orange-500 text-sm underline hover:text-orange-600 transition-colors">
              More details
            </a>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 w-full">
            ...
            {/* Step 1 */}
            <div className="flex items-center gap-4">
              <span className="text-orange-500 font-bold text-sm">STEP 1 &gt;</span>
              <div className="p-3 rounded-full border-2 border-orange-500/50 bg-orange-500/10 shadow-[0_0_15px_rgba(249,115,22,0.3)]">
            ...
            <span className="hidden md:block text-orange-500 font-bold">&gt;</span>

            {/* Step 2 */}
            <div className="flex items-center gap-4">
              <span className="text-orange-500 font-bold text-sm">STEP 2 &gt;</span>
              <div className="p-3 rounded-full border-2 border-orange-500/50 bg-orange-500/10 shadow-[0_0_15px_rgba(249,115,22,0.3)]">
            ...
            {/* Step 3 */}
            <div className="flex items-center gap-4">
              <span className="text-orange-500 font-bold text-sm">STEP 3 &gt;</span>
              <div className="p-3 rounded-full border-2 border-orange-500/50 bg-orange-500/10 shadow-[0_0_15px_rgba(249,115,22,0.3)]">
          ...
          {/* CTA Button */}
          <Button 
            className="mt-4 bg-orange-500 hover:bg-orange-600 text-black font-bold px-10 py-6 text-lg rounded-xl shadow-[0_0_20px_rgba(249,115,22,0.4)] transition-all hover:scale-105 cursor-pointer"
          >
            Join me88 Now
          </Button>
          ...
          {[
            ...
            <div 
              ...
              className="
                ...
                hover:shadow-[0_20px_40px_rgba(249,115,22,0.15)]
                cursor-default
              "
            >
              {/* Top Gradient Box */}
              <div className="
                w-full bg-gradient-to-b from-orange-400 to-orange-600 
              ...
              <div className="space-y-1">
                <h3 className="text-4xl font-bold text-orange-500 font-cuprum">
                  {stat.value}
                </h3>
              ...
              {/* Subtle Divider */}
              <div className="w-12 h-[1px] bg-white/10 my-6 transition-colors group-hover:bg-orange-500/30" />
